# Drone Object Detection Dataset 8900 images YOLO format supported clear images

# Body

Drone Object Detection Dataset, 8900 images, YOLO format supported, clear images, well-annotated, suitable for drone object detection, model training, scientific research experiments, large data volume, ready to use directly.
